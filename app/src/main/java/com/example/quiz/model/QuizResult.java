...
import com.example.quiz.data.db.converters.DateConverter;
import com.example.quiz.data.db.converters.QuestionsConverter;
...
public class QuizResult {
    ...
    public void setCorrectAnswersAmount(int correctAnswers) {
